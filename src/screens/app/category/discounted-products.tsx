...
type ScreenRouteProp = RouteProp<AppStackParamList, 'DiscountedProducts'>;
...
const DiscountedProductsScreen: React.FC<IProps> = (props) => {
    ...
    const getProducts = (
        ...
        CategoryService.getDiscountedProducts(page)
            .then(({ data }) => {
            ...
            .catch((error) => {
                console.log('ERROR LOADING DISCOUNTED PRODUCTS:', error);
            })
            .finally(() => {
...
export default memo(DiscountedProductsScreen);
